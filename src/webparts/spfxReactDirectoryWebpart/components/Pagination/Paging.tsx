    ...
    <div className={styles.paginationContainer}>
      <div className={styles.searchWp__paginationContainer__pagination}>
        <Pagination
          ...
          firstPageText={<i className="ms-Icon ms-Icon--DoubleChevronLeft" />}
          lastPageText={<i className="ms-Icon ms-Icon--DoubleChevronRight" />}
          prevPageText={<i className="ms-Icon ms-Icon--ChevronLeft" />}
          nextPageText={<i className="ms-Icon ms-Icon--ChevronRight" />}
