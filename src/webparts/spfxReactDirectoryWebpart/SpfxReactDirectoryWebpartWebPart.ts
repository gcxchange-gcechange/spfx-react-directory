...
//import SpfxReactDirectoryWebpart from './components/SpfxReactDirectoryWebpart';
//import { ISpfxReactDirectoryWebpartProps } from './components/ISpfxReactDirectoryWebpartProps';
...
export default class SpfxReactDirectoryWebpartWebPart extends BaseClientSideWebPart<ISpfxReactDirectoryWebpartWebPartProps> {
  ...
  // public render(): void {
  //   const element: React.ReactElement<ISpfxReactDirectoryWebpartProps> =
  //     React.createElement(SpfxReactDirectoryWebpart, {
